...
| **[Thành viên 4]** | **EV Trip Planner & Dijkstra**: Phát triển thuật toán `EVTripPlanner` dựa trên Dijkstra để tính toán điểm dừng sạc tối ưu. | `tools.py` |
| **[Thành viên 5]** | **UI Prototype (Gradio)**: Xây dựng giao diện Web Demo bằng Gradio, tích hợp Chat Streaming và ProgressBar hiển thị pin. | `toolsCS.py`, Link Gradio Demo |
